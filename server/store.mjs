...
export function openStore(path) {
  ...
  db.exec(`PRAGMA journal_mode=WAL; PRAGMA foreign_keys=ON; PRAGMA busy_timeout=5000;
    ...
    CREATE TABLE IF NOT EXISTS job_request_keys(userId TEXT NOT NULL REFERENCES users(id) ON DELETE CASCADE,kind TEXT NOT NULL,requestKey TEXT NOT NULL,jobId TEXT NOT NULL REFERENCES jobs(id) ON DELETE CASCADE,PRIMARY KEY(userId,kind,requestKey));
