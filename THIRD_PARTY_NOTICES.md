...
Miguel de Cervantes's original *Don Quijote* (1605/1615) is public domain. The application corpus was extracted from a 1920 Librería Bergua edition distributed by Elejandría from a Biblioteca Digital Hispánica copy. The original-work status does not by itself establish rights in every scan, transcription, editorial addition, or distributor artifact. Covers, preliminaries, promotions, and prologues are excluded; the source-edition provenance and hashes remain in `content/don-quixote.json`. Source-edition reuse remains an owner review item before submission.

The app's 15 narrow objectives and contextual glosses use Instituto Cervantes CVC pages as a classification and reference source. They are application-authored scopes, mappings, translations, and explanations, not an official CVC curriculum or endorsement. The local research mirror says “all rights reserved”; permission for any copied or adapted protected wording has not been established. Review or replace that material before contest submission. RAE pages are also reference sources, not bundled dictionaries.
